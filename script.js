...
allLinks.forEach((link) => {
  link.addEventListener("click", function (e) {
    e.preventDefault();
    let link = e.target;
    let ele = e.target.closest("a:link").getAttribute("href");
...
let headerHeight = Math.trunc(headerEl.getBoundingClientRect().height);
console.log(headerHeight);

let stickyNav = new IntersectionObserver(
  function (entries) {
    let [entry] = entries;
